...
#define HAVE_ATTR_use_carry
enum attr_use_carry {USE_CARRY_0, USE_CARRY_1};
extern enum attr_use_carry get_attr_use_carry (rtx);

#define HAVE_ATTR_movu
enum attr_movu {MOVU_0, MOVU_1};
extern enum attr_movu get_attr_movu (rtx);
...
#define HAVE_ATTR_bdver1_decode
enum attr_bdver1_decode {BDVER1_DECODE_DIRECT, BDVER1_DECODE_VECTOR, BDVER1_DECODE_DOUBLE};
extern enum attr_bdver1_decode get_attr_bdver1_decode (rtx);

#define HAVE_ATTR_atom_unit
enum attr_atom_unit {ATOM_UNIT_SISHUF, ATOM_UNIT_SIMUL, ATOM_UNIT_JEU, ATOM_UNIT_COMPLEX, ATOM_UNIT_OTHER};
extern enum attr_atom_unit get_attr_atom_unit (rtx);

#define HAVE_ATTR_atom_sse_attr
...
extern enum attr_atom_sse_attr get_attr_atom_sse_attr (rtx);

#define HAVE_ATTR_i7_domain
enum attr_i7_domain {I7_DOMAIN_INT, I7_DOMAIN_FLOAT, I7_DOMAIN_SIMD};
extern enum attr_i7_domain get_attr_i7_domain (rtx);
