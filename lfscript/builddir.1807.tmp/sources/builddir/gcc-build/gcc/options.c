...
const struct cl_option cl_options[] =
{
  ...
  { "-Wcast-qual",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 10, 176,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_WARNING,
  ...
  { "-Wchar-concat",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 12, 177,
    CL_Java,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-Wchar-subscripts",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 16, 178,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_WARNING,
  ...
  { "-Wcharacter-truncation",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 21, 179,
    CL_Fortran | CL_WARNING,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-Wclobbered",
  ...
  { "-Wcomments",
    ...
    0,
    0,
    NULL, NULL, OPT_Wcomment, N_OPTS, 9, 182,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_WARNING,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-Wcondition-assign",
    0,
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 17, 183,
    CL_Java,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-Wconstructor-name",
    0,
  ...
  { "-Wconversion-null",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 16, 187,
    CL_CXX | CL_ObjCXX | CL_WARNING,
  ...
  { "-Wcoverage-mismatch",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 18, 188,
    CL_COMMON | CL_WARNING,
  ...
  { "-Wdeclaration-after-statement",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 28, 191,
    CL_C | CL_ObjC | CL_WARNING,
  ...
  { "-Wdisabled-optimization",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 22, 195,
    CL_COMMON | CL_WARNING,
  ...
  { "-Wdiscouraged",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 12, 196,
    CL_Java,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-Wdiv-by-zero",
  ...
  { "-Wendif-labels",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 202,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_WARNING,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-Wenum-compare",
  ...
  { "-Wenum-identifier",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 16, 204,
    CL_Java,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-Wenum-switch",
    0,
  ...
  { "-Wextraneous-semicolon",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 21, 210,
    CL_Java,
  ...
  { "-Wfallthrough",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 12, 211,
    CL_Java,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-Wfatal-errors",
  ...
  { "-Wformat-contains-nul",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 20, 219,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_WARNING,
  ...
  { "-Wformat-extra-args",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 18, 220,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_WARNING,
  ...
  { "-Wformat-y2k",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 11, 223,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_WARNING,
  ...
  { "-Wformat-zero-length",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 19, 224,
    CL_C | CL_ObjC | CL_WARNING,
  ...
  { "-Wimplicit-function-declaration",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 30, 230,
    CL_C | CL_ObjC | CL_WARNING,
  ...
  { "-Wimplicit-int",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 231,
    CL_C | CL_ObjC | CL_WARNING,
  ...
  { "-Wimport",
    ...
    0,
    0,
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 7, 234,
  ...
  { "-Winit-self",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 10, 236,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_WARNING,
  ...
  { "-Wint-to-pointer-cast",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 20, 238,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_WARNING,
  ...
  { "-Wintrinsic-shadow",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 17, 241,
    CL_Fortran | CL_WARNING,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-Wintrinsics-std",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 15, 242,
    CL_Fortran | CL_WARNING,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-Winvalid-offsetof",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 17, 243,
    CL_CXX | CL_ObjCXX | CL_WARNING,
  ...
  { "-Winvalid-pch",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 12, 244,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_WARNING,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-Wjavadoc",
    0,
  ...
  { "-Wlogical-op",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 11, 252,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_WARNING,
  ...
  { "-Wmissing-braces",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 15, 256,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_WARNING,
  ...
  { "-Wmissing-field-initializers",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 27, 258,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_WARNING,
  ...
  { "-Wmissing-format-attribute",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 25, 259,
    CL_Ada | CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_WARNING,
  ...
  { "-Wmissing-include-dirs",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 21, 260,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_WARNING,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-Wmissing-noreturn",
  ...
  { "-Wmissing-parameter-type",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 23, 262,
    CL_C | CL_ObjC | CL_WARNING,
  ...
  { "-Wmultichar",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 10, 265,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_WARNING,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-Wnested-externs",
  ...
  { "-Wnon-virtual-dtor",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 17, 271,
    CL_CXX | CL_ObjCXX | CL_WARNING,
  ...
  { "-Wold-style-declaration",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 22, 276,
    CL_C | CL_ObjC | CL_WARNING,
  ...
  { "-Woverride-init",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 14, 283,
    CL_C | CL_ObjC | CL_WARNING,
  ...
  { "-Wpacked-bitfield-compat",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 23, 286,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_WARNING,
  ...
  { "-Wparam-assign",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 288,
    CL_Java,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-Wparentheses",
  ...
  { "-Wproperty-assign-default",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 24, 296,
    CL_ObjC | CL_ObjCXX | CL_WARNING,
  ...
  { "-Wreturn-type",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 12, 304,
    CL_C | CL_CXX | CL_Fortran | CL_ObjC | CL_ObjCXX | CL_WARNING,
  ...
  { "-Wsequence-point",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 15, 306,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_WARNING,
  ...
  { "-Wsign-conversion",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 16, 310,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX,
  ...
  { "-Wsign-promo",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 11, 311,
    CL_CXX | CL_ObjCXX | CL_WARNING,
  ...
  { "-Wspecial-param-hiding",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 21, 312,
    CL_Java,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-Wstack-protector",
  ...
  { "-Wstrict-null-sentinel",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 21, 318,
    CL_CXX | CL_ObjCXX | CL_WARNING,
  ...
  { "-Wstrict-selector-match",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 22, 322,
    CL_ObjC | CL_ObjCXX | CL_WARNING,
  ...
  { "-Wsurprising",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 11, 327,
    CL_Fortran | CL_WARNING,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-Wswitch",
  ...
  { "-Wsync-nand",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 10, 331,
    CL_C | CL_CXX | CL_WARNING,
  ...
  { "-Wsynthetic-access",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 17, 333,
    CL_Java,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-Wsystem-headers",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 15, 334,
  ...
  { "-Wtraditional",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 12, 337,
    CL_C | CL_ObjC | CL_WARNING,
  ...
  { "-Wtraditional-conversion",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 23, 338,
    CL_C | CL_ObjC | CL_WARNING,
  ...
  { "-Wunderflow",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 10, 346,
    CL_Fortran | CL_WARNING,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-Wuninitialized",
  ...
  { "-Wunqualified-field",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 18, 350,
    CL_Java,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-Wunreachable-code",
  ...
  { "-Wunsafe-loop-optimizations",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 26, 352,
    CL_COMMON | CL_WARNING,
  ...
  { "-Wunused-but-set-parameter",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 25, 356,
    CL_COMMON | CL_WARNING,
  ...
  { "-Wunused-but-set-variable",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 24, 357,
    CL_COMMON | CL_WARNING,
  ...
  { "-Wunused-label",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 361,
    CL_Java | CL_COMMON | CL_WARNING,
  ...
  { "-Wunused-macros",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 14, 363,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_WARNING,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-Wunused-parameter",
  ...
  { "-Wunused-private",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 15, 365,
    CL_Java,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-Wunused-result",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 14, 366,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_WARNING,
  ...
  { "-Wunused-value",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 368,
    CL_COMMON | CL_WARNING,
  ...
  { "-Wunused-variable",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 16, 369,
    CL_COMMON | CL_WARNING,
  ...
  { "-Wuseless-type-check",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 19, 370,
    CL_Java,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-Wvarargs-cast",
    0,
  ...
  { "-Wvolatile-register-var",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 22, 374,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_WARNING,
  ...
  { "-cpp",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 3, 1040,
    CL_Fortran,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-cpp=",
    0,
  ...
  { "-falign-jumps",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 12, 411,
    CL_COMMON | CL_UINTEGER | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-falign-labels",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 413,
    CL_COMMON | CL_UINTEGER | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fall-virtual",
    ...
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 12, 418,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fallow-leading-underscore",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 25, 419,
  ...
  { "-falt-external-templates",
    ...
    0,
    "switch %qs is no longer supported",
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 23, 420,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fargument-alias",
    "Does nothing. Preserved for backward compatibility.",
    0,
    0,
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 15, 421,
    CL_COMMON,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fargument-noalias",
    "Does nothing. Preserved for backward compatibility.",
    0,
    0,
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 17, 422,
    CL_COMMON,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fargument-noalias-anything",
    ...
    0,
    0,
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 26, 423,
    CL_COMMON,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fargument-noalias-global",
    ...
    0,
    0,
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 24, 424,
    CL_COMMON,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fasm",
  ...
  { "-fassume-compiled=",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 17, 429,
  ...
  { "-fauto-inc-dec",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 431,
    CL_COMMON | CL_REPORT,
  ...
  { "-fautomatic",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 10, 432,
    CL_Fortran,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-faux-classpath",
    0,
  ...
  { "-fbackslash",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 10, 434,
    CL_Fortran,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fbacktrace",
  ...
  { "-fbootstrap-classes",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 18, 438,
    CL_Java,
  ...
  { "-fbounds-check",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 439,
    CL_COMMON | CL_REPORT,
  ...
  { "-fbranch-probabilities",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 21, 441,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fbranch-target-load-optimize",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 28, 442,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fbranch-target-load-optimize2",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 29, 443,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fcheck-array-temporaries",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 24, 450,
    CL_Fortran,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fcheck-data-deps",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 16, 451,
    CL_COMMON | CL_REPORT,
  ...
  { "-fcheck-new",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 10, 452,
    CL_CXX | CL_ObjCXX,
  ...
  { "-fcprop-registers",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 16, 473,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fcse-skip-blocks",
    ...
    0,
    0,
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 16, 477,
    CL_COMMON,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fcx-fortran-rules",
  ...
  { "-fdbg-cnt-list",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 483,
    CL_COMMON | CL_REPORT,
    offsetof (struct gcc_options, x_common_deferred_options), 0, CLVC_DEFER, 0 },
  { "-fdbg-cnt=",
  ...
  { "-fdefault-inline",
    ...
    0,
    0,
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 15, 489,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fdefault-integer-8",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 18, 490,
    CL_Fortran,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fdefault-real-8",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 15, 491,
    CL_Fortran,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fdefer-pop",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 10, 492,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fdelete-null-pointer-checks",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 27, 494,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fdevirtualize",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 495,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fdiagnostics-show-option",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 24, 497,
    CL_COMMON,
  ...
  { "-fdirectives-only",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 16, 498,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fdisable-assertions",
    0,
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 19, 499,
    CL_Java,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fdisable-assertions=",
    0,
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 20, 500,
    CL_Java | CL_JOINED | CL_MISSING_OK,
    -1, 0, CLVC_STRING, 0 },
  { "-fdollar-ok",
  ...
  { "-fdollars-in-identifiers",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 23, 502,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fdse",
  ...
  { "-fdump-core",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, OPT_fdump_, 10, 505,
    CL_Fortran,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fdump-final-insns",
    0,
  ...
  { "-fdump-fortran-optimized",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, OPT_fdump_, 23, 508,
    CL_Fortran,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fdump-fortran-original",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, OPT_fdump_, 22, 509,
    CL_Fortran,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fdump-go-spec=",
  ...
  { "-fdump-noaddr",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, OPT_fdump_, 12, 511,
    CL_COMMON | CL_REPORT,
  ...
  { "-fdump-parse-tree",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, OPT_fdump_, 16, 512,
    CL_Fortran,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fdump-unnumbered",
  ...
  { "-fdump-unnumbered-links",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, OPT_fdump_, 22, 514,
    CL_COMMON | CL_REPORT,
  ...
  { "-fdwarf2-cfi-asm",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 15, 515,
    CL_COMMON | CL_REPORT,
  ...
  { "-felide-constructors",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 19, 517,
    CL_CXX | CL_ObjCXX,
  ...
  { "-feliminate-dwarf2-dups",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 22, 518,
    CL_COMMON | CL_REPORT,
  ...
  { "-feliminate-unused-debug-symbols",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 31, 519,
    CL_COMMON | CL_REPORT,
  ...
  { "-feliminate-unused-debug-types",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 29, 520,
  ...
  { "-femit-class-debug-always",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 24, 521,
    CL_COMMON | CL_REPORT,
  ...
  { "-femit-struct-debug-detailed=",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 28, 525,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_JOINED,
    -1, 0, CLVC_STRING, 0 },
  { "-femit-struct-debug-reduced",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 26, 526,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fenable-assertions",
    0,
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 18, 527,
    CL_Java,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fenable-assertions=",
    0,
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 19, 528,
    CL_Java | CL_JOINED | CL_MISSING_OK,
    -1, 0, CLVC_STRING, 0 },
  { "-fenable-icf-debug",
  ...
  { "-fenforce-eh-specs",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 17, 531,
    CL_CXX | CL_ObjCXX,
  ...
  { "-fenum-int-equiv",
    ...
    0,
    "switch %qs is no longer supported",
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 15, 532,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fexceptions",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 11, 533,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fexpensive-optimizations",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 24, 536,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fexternal-blas",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 14, 539,
    CL_Fortran,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fexternal-templates",
    0,
    0,
    "switch %qs is no longer supported",
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 19, 540,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-ff2c",
  ...
  { "-ffloat-store",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 12, 549,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-ffor-scope",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 10, 550,
    CL_CXX | CL_ObjCXX,
  ...
  { "-fforce-addr",
    ...
    0,
    0,
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 11, 551,
    CL_COMMON,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fforce-classes-archive-check",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 28, 552,
    CL_Java,
  ...
  { "-fforward-propagate",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 18, 553,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-ffreestanding",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 559,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-ffriend-injection",
  ...
  { "-ffunction-cse",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 561,
    CL_COMMON | CL_REPORT,
  ...
  { "-fgcse-after-reload",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 18, 564,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fgnu-keywords",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 568,
    CL_CXX | CL_ObjCXX,
  ...
  { "-fguess-branch-probability",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 25, 575,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fguiding-decls",
    ...
    0,
    "switch %qs is no longer supported",
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 14, 576,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fhandle-exceptions",
    0,
    ...
    NULL, NULL, OPT_fexceptions, N_OPTS, 18, 577,
  ...
  { "-fhash-synchronization",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 21, 578,
    CL_Java,
  ...
  { "-fhelp",
    ...
    0,
    0,
    NULL, NULL, OPT__help, N_OPTS, 5, 579,
    CL_COMMON | CL_DRIVER,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fhelp=",
    0,
    0,
    0,
    NULL, NULL, OPT__help_, N_OPTS, 6, 580,
  ...
  { "-fhonor-std",
    ...
    0,
    "switch %qs is no longer supported",
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 10, 581,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fhosted",
  ...
  { "-fhuge-objects",
    ...
    0,
    "switch %qs is no longer supported",
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 13, 583,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fident",
  ...
  { "-fimplement-inlines",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 18, 587,
    CL_CXX | CL_ObjCXX,
  ...
  { "-fimplicit-none",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 14, 589,
    CL_Fortran,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fimplicit-templates",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 19, 590,
    CL_CXX | CL_ObjCXX,
  ...
  { "-finhibit-size-directive",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 23, 594,
    CL_COMMON | CL_REPORT,
  ...
  { "-finit-local-zero",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 16, 597,
    CL_Fortran,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-finit-logical=",
  ...
  { "-finline-functions",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 17, 601,
  ...
  { "-finline-functions-called-once",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 29, 602,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-finline-small-functions",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 23, 605,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fipa-reference",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 14, 617,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fira-share-save-slots",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 21, 623,
    CL_COMMON | CL_REPORT,
  ...
  { "-fira-share-spill-slots",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 22, 624,
    CL_COMMON | CL_REPORT,
  ...
  { "-fkeep-static-consts",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 19, 631,
    CL_COMMON | CL_REPORT,
  ...
  { "-flabels-ok",
    ...
    0,
    "switch %qs is no longer supported",
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 10, 632,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  ...
  { "-fleading-underscore",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 19, 634,
    CL_COMMON | CL_REPORT,
  ...
  { "-floop-block",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 11, 635,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-floop-flatten",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 636,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-floop-interchange",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 17, 637,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-floop-optimize",
    ...
    0,
    0,
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 14, 638,
    CL_COMMON,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-floop-parallelize-all",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 21, 639,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-flto-partition=1to1",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 19, 643,
    CL_COMMON,
  ...
  { "-flto-partition=balanced",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 23, 644,
    CL_COMMON,
  ...
  { "-fltrans-output-list=",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 20, 649,
    CL_LTO | CL_JOINED,
  ...
  { "-fmem-report",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 11, 657,
    CL_COMMON | CL_REPORT,
  ...
  { "-fmerge-all-constants",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 20, 658,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fmerge-constants",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 16, 659,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fmerge-debug-strings",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 20, 660,
    CL_COMMON | CL_REPORT,
  ...
  { "-fmodule-private",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 15, 662,
    CL_Fortran,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fmodulo-sched",
  ...
  { "-fmodulo-sched-allow-regmoves",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 28, 664,
    CL_COMMON | CL_REPORT,
  ...
  { "-fname-mangling-version-",
    ...
    0,
    "switch %qs is no longer supported",
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 23, 670,
  ...
  { "-fnew-abi",
    ...
    0,
    "switch %qs is no longer supported",
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 8, 671,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fnext-runtime",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 672,
    CL_ObjC | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fnil-receivers",
  ...
  { "-fnon-call-exceptions",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 20, 674,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fnonansi-builtins",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 17, 675,
    CL_CXX | CL_ObjCXX,
  ...
  { "-fnonnull-objects",
    ...
    0,
    "switch %qs is no longer supported",
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 16, 676,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fnothrow-opt",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 12, 677,
    CL_CXX | CL_ObjCXX | CL_OPTIMIZATION,
  ...
  { "-fobjc-call-cxx-cdtors",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 21, 679,
    CL_ObjCXX,
  ...
  { "-fobjc-exceptions",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 16, 681,
    CL_ObjC | CL_ObjCXX,
  ...
  { "-fobjc-std=objc1",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 15, 685,
    CL_ObjC | CL_ObjCXX,
  ...
  { "-fomit-frame-pointer",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 19, 686,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-foptimize-register-move",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 23, 689,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-foptimize-static-class-initialization",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 37, 691,
    CL_Java,
  ...
  { "-foptional-diags",
    ...
    0,
    0,
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 15, 692,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-foutput-class-dir=",
    0,
  ...
  { "-fpack-derived",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 694,
    CL_Fortran,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fpack-struct",
  ...
  { "-fpch-preprocess",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 15, 700,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fpeel-loops",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 11, 701,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fpeephole2",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 10, 703,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fpermissive",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 11, 704,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fpic",
  ...
  { "-fplan9-extensions",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 17, 707,
    CL_C | CL_ObjC,
  ...
  { "-fprofile-use",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 12, 722,
    CL_COMMON,
  ...
  { "-frandom-seed",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 12, 726,
    CL_COMMON,
    offsetof (struct gcc_options, x_common_deferred_options), 0, CLVC_DEFER, 0 },
  { "-frandom-seed=",
  ...
  { "-frange-check",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 12, 728,
    CL_Fortran,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-frealloc-lhs",
  ...
  { "-frecursive",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 10, 734,
    CL_Fortran,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-freduced-reflection",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 19, 735,
    CL_Java,
  ...
  { "-freg-struct-return",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 18, 736,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-freorder-blocks-and-partition",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 29, 740,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-frequire-return-statement",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 25, 745,
    CL_Go | CL_WARNING,
  ...
  { "-frerun-loop-opt",
    ...
    0,
    0,
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 15, 747,
    CL_COMMON,
    -1, 0, CLVC_BOOLEAN, 0 },
  ...
  { "-fresolution=",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 12, 749,
    CL_LTO | CL_JOINED,
    -1, 0, CLVC_STRING, 0 },
  { "-frounding-math",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 14, 750,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fsched-critical-path-heuristic",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 30, 753,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fsched-last-insn-heuristic",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 26, 757,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fsched-pressure",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 15, 758,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fsched-spec",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 11, 760,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fsched-spec-insn-heuristic",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 26, 761,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fsched-spec-load-dangerous",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 26, 763,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fsched-stalled-insns",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 20, 764,
    CL_COMMON | CL_UINTEGER | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fsched-stalled-insns-dep",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 24, 765,
    CL_COMMON | CL_UINTEGER | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fsched2-use-superblocks",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 23, 769,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fsched2-use-traces",
    ...
    0,
    0,
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 18, 770,
    CL_COMMON,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fschedule-insns",
  ...
  { "-fsee",
    ...
    0,
    0,
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 4, 775,
    CL_COMMON,
    -1, 0, CLVC_BOOLEAN, 0 },
  ...
  { "-fsel-sched-pipelining-outer-loops",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 33, 777,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fsel-sched-reschedule-pipelined",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 31, 778,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fselective-scheduling2",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 22, 780,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fshort-double",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 781,
  ...
  { "-fsign-zero",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 10, 785,
    CL_Fortran,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fsignaling-nans",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 15, 786,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fsigned-bitfields",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 17, 787,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX,
  ...
  { "-fsingle-precision-constant",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 26, 790,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fsplit-wide-types",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 17, 795,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fsquangle",
    ...
    0,
    "switch %qs is no longer supported",
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 9, 796,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fstack-check",
    ...
    0,
    0,
    "specific", "no", OPT_fstack_check_, N_OPTS, 12, 797,
    CL_COMMON,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fstack-check=",
  ...
  { "-fstore-check",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 12, 806,
    CL_Java,
  ...
  { "-fstrength-reduce",
    ...
    0,
    0,
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 16, 807,
    CL_COMMON,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fstrict-aliasing",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 16, 808,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fstrict-enums",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 809,
    CL_CXX | CL_ObjCXX | CL_OPTIMIZATION,
  ...
  { "-fstrict-overflow",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 16, 810,
    CL_COMMON | CL_REPORT,
  ...
  { "-fstrict-prototype",
    ...
    0,
    "switch %qs is no longer supported",
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 17, 811,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fstrict-volatile-bitfields",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 26, 812,
    CL_COMMON | CL_REPORT,
  ...
  { "-ftarget-help",
    ...
    0,
    0,
    NULL, NULL, OPT__target_help, N_OPTS, 12, 815,
    CL_COMMON | CL_DRIVER,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-ftarget=",
  ...
  { "-fthis-is-variable",
    ...
    0,
    "switch %qs is no longer supported",
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 17, 820,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fthread-jumps",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 821,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fthreadsafe-statics",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 19, 822,
    CL_CXX | CL_ObjCXX | CL_OPTIMIZATION,
  ...
  { "-ftrapping-math",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 14, 827,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-ftree-bit-ccp",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 829,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-ftree-copyrename",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 16, 834,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-ftree-cselim",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 12, 835,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-ftree-dominator-opts",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 20, 837,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-ftree-loop-distribute-patterns",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 30, 841,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-ftree-loop-distribution",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 23, 842,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-ftree-loop-if-convert",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 21, 843,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-ftree-loop-if-convert-stores",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 28, 844,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-ftree-loop-im",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 845,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-ftree-loop-ivcanon",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 18, 846,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-ftree-loop-linear",
    ...
    0,
    0,
    NULL, NULL, OPT_floop_interchange, N_OPTS, 17, 847,
    CL_COMMON,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-ftree-loop-optimize",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 19, 848,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-ftree-phiprop",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 851,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-ftree-salias",
    ...
    0,
    0,
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 12, 855,
    CL_COMMON,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-ftree-scev-cprop",
  ...
  { "-ftree-sink",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 10, 857,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-ftree-slp-vectorize",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 19, 858,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-ftree-store-ccp",
    ...
    0,
    0,
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 15, 860,
    CL_COMMON,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-ftree-store-copy-prop",
    ...
    0,
    0,
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 21, 861,
    CL_COMMON,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-ftree-switch-conversion",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 23, 862,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-funroll-loops",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 871,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-funsafe-loop-optimizations",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 26, 872,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-funsigned-bitfields",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 19, 874,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX,
  ...
  { "-funsigned-char",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 14, 875,
    CL_C | CL_CXX | CL_LTO | CL_ObjC | CL_ObjCXX,
  ...
  { "-funswitch-loops",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 15, 876,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-funwind-tables",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 14, 877,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fuse-boehm-gc",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 879,
    CL_Java,
  ...
  { "-fuse-cxa-get-exception-ptr",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 26, 881,
    CL_CXX | CL_ObjCXX,
  ...
  { "-fuse-divide-subroutine",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 22, 882,
    CL_Java,
  ...
  { "-fuse-linker-plugin",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 18, 883,
  ...
  { "-fvar-tracking-assignments",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 25, 885,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fvar-tracking-assignments-toggle",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 32, 886,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fvar-tracking-uninit",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 20, 887,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fvariable-expansion-in-unroller",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 31, 888,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fversion",
    ...
    0,
    0,
    NULL, NULL, OPT__version, N_OPTS, 8, 891,
    CL_COMMON | CL_DRIVER,
    -1, 0, CLVC_BOOLEAN, 0 },
  ...
  { "-fvtable-gc",
    ...
    0,
    "switch %qs is no longer supported",
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 10, 896,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fvtable-thunks",
    "No longer supported",
    0,
    "switch %qs is no longer supported",
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 14, 897,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fweak",
  ...
  { "-fwhole-file",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 11, 900,
    CL_Fortran,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fwhole-program",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 14, 901,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fworking-directory",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 18, 903,
    CL_C | CL_CXX | CL_Fortran | CL_ObjC | CL_ObjCXX,
  ...
  { "-fxref",
    ...
    0,
    "switch %qs is no longer supported",
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 5, 906,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fzee",
  ...
  { "-fzero-initialized-in-bss",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 24, 908,
    CL_COMMON | CL_REPORT,
  ...
  { "-fzero-link",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 10, 909,
    CL_ObjC | CL_ObjCXX,
  ...
  { "-gstabs+",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, OPT_gstabs, 7, 923,
    CL_COMMON | CL_JOINED | CL_MISSING_OK,
    -1, 0, CLVC_STRING, 0 },
  { "-gstrict-dwarf",
  ...
  { "-gxcoff+",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, OPT_gxcoff, 7, 912,
    CL_COMMON | CL_JOINED | CL_MISSING_OK,
    -1, 0, CLVC_STRING, 0 },
  { "-h",
    0,
  ...
  { "-maccumulate-outgoing-args",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 25, 951,
    CL_TARGET | CL_SAVE | CL_REPORT,
  ...
  { "-malign-double",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 953,
    CL_TARGET | CL_SAVE | CL_REPORT,
  ...
  { "-mavx256-split-unaligned-load",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 28, 962,
    CL_TARGET | CL_SAVE | CL_REPORT,
  ...
  { "-mavx256-split-unaligned-store",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 29, 963,
    CL_TARGET | CL_SAVE | CL_REPORT,
  ...
  { "-mforce-drap",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 11, 978,
    CL_TARGET | CL_REPORT,
  ...
  { "-mfp-ret-in-387",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 14, 979,
    CL_TARGET | CL_SAVE | CL_REPORT,
  ...
  { "-mfused-madd",
    ...
    "fast", "off", OPT_ffp_contract_, N_OPTS, 11, 982,
  ...
  { "-mglibc",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 6, 1032,
    CL_TARGET | CL_REJECT_NEGATIVE | CL_REPORT,
  ...
  { "-minline-all-stringops",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 21, 987,
    CL_TARGET | CL_SAVE | CL_REPORT,
  ...
  { "-minline-stringops-dynamically",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 29, 988,
    CL_TARGET | CL_SAVE | CL_REPORT,
  ...
  { "-mintel-syntax",
    ...
    "intel", "att", OPT_masm_, N_OPTS, 13, 989,
    CL_TARGET | CL_UNDOCUMENTED,
    -1, 0, CLVC_BOOLEAN, 0 },
  ...
  { "-mms-bitfields",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 994,
    CL_TARGET | CL_SAVE | CL_REPORT,
  ...
  { "-mpclmul",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, OPT_mpc, 7, 1002,
    CL_TARGET | CL_SAVE | CL_REPORT,
  ...
  { "-mprefer-avx128",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 14, 1004,
    CL_TARGET | CL_REPORT,
  ...
  { "-mpush-args",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 10, 1006,
    CL_TARGET | CL_SAVE | CL_REPORT,
  ...
  { "-mrdrnd",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 6, 1007,
    CL_TARGET | CL_SAVE | CL_REPORT,
  ...
  { "-mrecip",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 6, 1008,
    CL_TARGET | CL_SAVE | CL_REPORT,
  ...
  { "-msoft-float",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 11, 1013,
    CL_TARGET | CL_SAVE,
  ...
  { "-msse2avx",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 8, 1016,
    CL_TARGET | CL_REPORT,
  ...
  { "-msse3",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 5, 1017,
    CL_TARGET | CL_SAVE | CL_REPORT,
  ...
  { "-msse4.1",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 7, 1019,
    CL_TARGET | CL_SAVE | CL_REPORT,
  ...
  { "-msse4.2",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 7, 1020,
    CL_TARGET | CL_SAVE | CL_REPORT,
    offsetof (struct gcc_options, x_ix86_isa_flags), 0, CLVC_BIT_SET, OPTION_MASK_ISA_SSE4_2 },
  { "-msse4a",
  ...
  { "-msse5",
    ...
    0,
    "%<-msse5%> was removed",
    NULL, NULL, OPT_mavx, N_OPTS, 5, 1022,
    CL_TARGET | CL_UNDOCUMENTED,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-msseregparm",
  ...
  { "-mssse3",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 6, 1024,
    CL_TARGET | CL_SAVE | CL_REPORT,
  ...
  { "-mstack-arg-probe",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 16, 1025,
    CL_TARGET | CL_SAVE | CL_REPORT,
  ...
  { "-mstackrealign",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 1026,
    CL_TARGET | CL_REPORT,
  ...
  { "-mtls-direct-seg-refs",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 20, 1030,
    CL_TARGET | CL_REPORT,
  ...
  { "-mvect8-ret-in-mem",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 17, 1034,
    CL_TARGET | CL_SAVE | CL_REPORT,
  ...
  { "-mvzeroupper",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 11, 1035,
    CL_TARGET | CL_SAVE | CL_REPORT,
  ...
  { "-mxop",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 4, 1036,
    CL_TARGET | CL_SAVE | CL_REPORT,
  ...
  { "-pie",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 3, 1075,
    CL_COMMON | CL_REJECT_NEGATIVE,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-pipe",
    0,
