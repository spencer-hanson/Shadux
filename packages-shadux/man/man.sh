#Compresses manual files
#!/bin/bash
function usage() {
        echo Usage $0 [--install] [--update]
        echo --install installs the manual file compression to the system
        echo --update updates the data for manual file compression
}
